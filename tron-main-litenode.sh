...
wget "${BASE_URL}${LAST_FOLDER}LiteFullNode_output-directory.tgz"
wget "${BASE_URL}${LAST_FOLDER}LiteFullNode_output-directory.tgz.md5sum"
...
nohup java -Xms9G -Xmx9G -XX:ReservedCodeCacheSize=256m \
    ...
    -jar FullNode.jar --es -c main_net_config.conf >> start.log 2>&1 &